        ...
        <section class="p-8">
            ...
            <div class="bg-green-50 border border-green-200 rounded-xl p-5 mb-6">
                <div class="flex items-center gap-4">
                    <div
                        class="w-14 h-14 bg-green-700 rounded-full flex items-center justify-center text-white text-xl font-bold">
                        {{ auth()->user()->initials() }}
                    </div>
                    <div>
                        ...
                        <span
                            class="inline-block mt-1 px-3 py-0.5 bg-green-700 text-white text-xs font-semibold rounded-full">
                            {{ auth()->user()->roleName() }}
                        </span>
                    </div>
                </div>
