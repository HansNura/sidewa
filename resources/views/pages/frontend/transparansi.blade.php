        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10" x-data="{ imageModalOpen: false }">
                ...
                <div
                    ...
                    <select id="tahunAnggaran"
                        ...
                        @foreach ($availableYears as $year)
                            <option value="{{ $year }}" {{ $tahunBerjalan == $year ? 'selected' : '' }}>Tahun
                                {{ $year }}</option>
                        @endforeach
                    </select>
                </div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-14">
                ...
                <section class="lg:col-span-2">
                    <h3 class="text-lg font-bold text-gray-800 mb-4 border-b border-gray-200 pb-2">Breakdown Pembiayaan
                        Desa</h3>
                    <div class="bg-white rounded-xl shadow-sm overflow-hidden border border-gray-200">
                        <table class="min-w-full divide-y divide-gray-200">
                            <thead class="bg-gray-50">
                                <tr>
                                    <th scope="col"
                                        class="px-6 py-3 text-left text-xs font-semibold text-gray-500 uppercase">Uraian
                                        Pembiayaan</th>
                                    <th scope="col"
                                        class="px-6 py-3 text-right text-xs font-semibold text-gray-500 uppercase">Anggaran
                                        (Rp)</th>
                                </tr>
                            </thead>
                            <tbody class="bg-white divide-y divide-gray-100">
                                @if (count($rincianPembiayaan['penerimaan']) > 0)
                                    <tr class="bg-gray-50/80">
                                        <td colspan="2" class="px-6 py-2 text-xs font-bold text-gray-500">
                                            <i class="fa-solid fa-plus-circle text-green-500 mr-2"></i>Penerimaan
                                            Pembiayaan
                                        </td>
                                    </tr>
                                ...
                                @if (count($rincianPembiayaan['pengeluaran']) > 0)
                                    <tr class="bg-gray-50/80">
                                        <td colspan="2"
                                            class="px-6 py-2 text-xs font-bold text-gray-500 border-t border-gray-200">
                                            <i class="fa-solid fa-minus-circle text-red-500 mr-2"></i>Pengeluaran
                                            Pembiayaan
                                        </td>
                                    </tr>
                                ...
                                @if (count($rincianPembiayaan['penerimaan']) === 0 && count($rincianPembiayaan['pengeluaran']) === 0)
                                    <tr>
                                        <td colspan="2" class="px-6 py-4 text-sm text-gray-500 text-center italic">
                                            Belum ada data pembiayaan untuk tahun ini.</td>
                                    </tr>
                                @endif
                            </tbody>
                            <tfoot class="bg-purple-50 border-t-2 border-purple-200">
                                <tr>
                                    ...
                                    <td class="px-6 py-4 text-sm font-bold text-purple-700 text-right">
                                        {{ number_format($apbdesRingkasan['pembiayaan_netto'], 0, ',', '.') }}</td>
                                </tr>
                            </tfoot>
                        </table>
                    </div>
            ...
            <section class="mb-14">
                ...
                <div class="relative max-w-4xl mx-auto rounded-3xl overflow-hidden shadow-2xl z-10
                    ...
                    <img src="{{ $posterCurrent?->gambar_baliho_url ?? 'https://placehold.co/1200x800/E8F5E9/2E7D32?text=Baliho+Belum+Diunggah' }}"
                        alt="Visual Infografis APBDes TA {{ $tahunBerjalan }}"
                    ...
                    <div
                        ...
                        <div
                            class="text-left w-full flex flex-col sm:flex-row justify-between items-start sm:items-end gap-4">
                            <div>
