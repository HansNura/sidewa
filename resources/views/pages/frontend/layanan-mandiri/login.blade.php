    ...
    <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center">
            ...
            <section class="order-2 lg:order-1">
                <article class="bg-white rounded-3xl shadow-xl border border-gray-100 overflow-hidden">
                    ...
                    <div class="px-8 pt-8 pb-6 text-center border-b border-gray-100">
                        <div class="w-16 h-16 bg-green-50 rounded-2xl flex items-center justify-center mx-auto mb-4 text-green-600 border border-green-100 shadow-sm">
                    ...
                    {{-- Session Status --}}
                    @if (session('status'))
                        <div class="mx-8 mt-6 text-sm text-green-600 bg-green-50 border border-green-200 rounded-xl px-4 py-3 text-center">
                            {{ session('status') }}
                        </div>
                    @endif
                    ...
                    {{-- Validation Errors --}}
                    @if ($errors->any())
                        <div class="mx-8 mt-6 text-sm text-red-600 bg-red-50 border border-red-200 rounded-xl px-4 py-3">
                    ...
                    {{-- Body Form --}}
                    <form action="{{ route('layanan.mandiri.authenticate') }}" method="POST" class="p-8" id="wargaLoginForm"
                          x-data="{ showPin: false }">
                        @csrf
            ...
            <section class="order-1 lg:order-2 space-y-6">
                ...
                {{-- Bantuan Login --}}
                <div id="bantuan" class="bg-amber-50 border border-amber-100 rounded-2xl p-6 flex gap-4 items-start shadow-sm mt-4">
                    <div class="bg-amber-100 text-amber-600 w-12 h-12 rounded-full flex items-center justify-center shrink-0">
