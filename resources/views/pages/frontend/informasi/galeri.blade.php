...
<main class="flex-grow pt-16 bg-gray-50" x-data="galeriData()">
    ...
    <section class="bg-gradient-to-br from-green-800 to-green-600 text-white py-16 md:py-20 relative overflow-hidden">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
            <span
                class="bg-green-700/50 text-green-100 text-sm font-semibold px-3 py-1 rounded-full border border-green-500/30 mb-4 inline-block">Galeri Visual</span>
    ...
    <div class="px-4 py-10 mx-auto max-w-7xl sm:px-6 lg:px-8">
        ...
        <section class="flex flex-wrap justify-center gap-3 pb-8 mb-10 border-b border-gray-200">
            ...
            <button class="px-5 py-2.5 text-sm {{ $index == 0 ? 'bg-green-600 text-white font-semibold shadow-sm hover:bg-green-700' : 'bg-white text-gray-600 border border-gray-300 font-medium hover:bg-green-50 hover:text-green-600 hover:border-green-300' }} rounded-full transition-colors">
                {{ $kategori }}
            </button>
            @endforeach
        </section>
        ...
        <section class="mb-16">
            ...
            <div class="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3 md:gap-8">
                ...
                <!-- Foto Card -->
                <figure @click="openLightbox({{ $index }})" class="relative group cursor-pointer overflow-hidden rounded-2xl shadow-sm border border-gray-200 bg-gray-100 aspect-[4/3]">
                    <!-- Gambar -->
                    ...
                    <div class="absolute inset-0 flex flex-col justify-end p-5 transition-opacity duration-300 opacity-0 bg-gradient-to-t from-gray-900/90 via-gray-900/20 to-transparent group-hover:opacity-100">
                        <span class="bg-{{ $foto['kategori_warna'] }}-500 text-white text-[10px] font-bold px-2 py-1 rounded uppercase tracking-wider w-max mb-2">
                            {{ $foto['kategori'] }}
                        </span>
                    ...
                    <div class="absolute inset-0 z-10 flex items-center justify-center transition-opacity duration-300 opacity-0 pointer-events-none group-hover:opacity-100">
                        <div class="flex items-center justify-center w-12 h-12 text-white rounded-full bg-white/20 backdrop-blur-sm">
        ...
        <section class="flex items-center justify-center gap-2 pb-12 mb-16 border-b border-gray-200">
            ...
            <button class="flex items-center justify-center w-10 h-10 font-medium text-gray-600 transition-colors bg-white border border-gray-200 rounded-lg hover:bg-gray-50 hover:text-[#2e7d32]">2</button>
            <button class="flex items-center justify-center w-10 h-10 font-medium text-gray-600 transition-colors bg-white border border-gray-200 rounded-lg hover:bg-gray-50 hover:text-[#2e7d32]">3</button>
        ...
        <section class="mb-10">
            ...
            <div class="grid grid-cols-1 gap-8 md:grid-cols-2">
                ...
                <!-- Video Card -->
                <div class="overflow-hidden transition-shadow bg-white border border-gray-200 rounded-2xl shadow-sm hover:shadow-md group">
                    ...
                    <div class="relative overflow-hidden cursor-pointer aspect-video bg-gray-900">
                        ...
                        <div class="absolute inset-0 flex items-center justify-center">
                            <div class="flex items-center justify-center w-16 h-16 text-white transition-all bg-red-600 rounded-full shadow-lg group-hover:scale-110 group-hover:bg-red-700">
                        ...
                        <div class="absolute px-2 py-1 text-xs font-bold text-white rounded bottom-3 right-3 bg-black/80">
                            {{ $video['durasi'] }}
                        </div>
                    </div>
                    <div class="p-5">
                        <h3 class="mb-2 text-lg font-bold text-gray-800 transition-colors group-hover:text-green-600">{{ $video['judul'] }}</h3>
        ...
        <template x-if="activeImage !== null">
            <div class="relative flex items-center justify-center w-full h-full">
                ...
                <div class="absolute top-0 left-0 right-0 z-20 flex items-center justify-between p-4 md:p-6 bg-gradient-to-b from-black/70 to-transparent">
                    <p class="text-lg font-semibold text-white md:text-xl drop-shadow-md" x-text="daftarFoto[activeImage].judul"></p>
