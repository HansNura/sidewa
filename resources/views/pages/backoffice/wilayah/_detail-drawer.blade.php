...
<div x-show="detailDrawerOpen" class="fixed inset-0 z-[100] flex justify-end" x-cloak>
    ...
    <div x-show="detailDrawerOpen"
        ...
        <div class="px-6 py-5 border-b border-gray-100 flex justify-between items-start bg-gray-50/50 shrink-0">
            <div>
                <span class="text-[10px] font-bold text-amber-600 bg-amber-100 px-2 py-0.5 rounded uppercase tracking-wider mb-1 inline-block"
        ...
        <div class="p-6 overflow-y-auto custom-scrollbar flex-1 space-y-6" x-show="detail">
            ...
            <template x-if="detail?.kepala_nama">
                <div class="bg-white border border-gray-200 rounded-xl p-4 shadow-sm flex items-center gap-4">
                    <div class="w-12 h-12 rounded-full bg-gray-200 overflow-hidden shrink-0 border-2 border-white shadow-sm flex items-center justify-center bg-amber-100 text-amber-700">
                        <i class="fa-solid fa-user-tie text-lg"></i>
                    </div>
                    <div>
                        <p class="text-[10px] text-gray-500 uppercase font-bold tracking-wider mb-0.5">Kepala Wilayah</p>
                        <h4 class="font-bold text-gray-900 leading-tight" x-text="detail.kepala_nama"></h4>
                        <p class="text-xs text-gray-600 mt-0.5" x-show="detail.kepala_jabatan" x-text="detail.kepala_jabatan"></p>
            ...
            <div>
                ...
                <div class="grid grid-cols-2 gap-3">
                    <div class="bg-blue-50 border border-blue-100 p-3 rounded-xl text-center">
                        ...
                        <h3 class="text-xl font-extrabold text-blue-800" x-text="detail?.populasi?.toLocaleString() ?? '0'"></h3>
                    </div>
                    <div class="bg-green-50 border border-green-100 p-3 rounded-xl text-center">
                        ...
                        <h3 class="text-xl font-extrabold text-green-800" x-text="detail?.jumlah_kk?.toLocaleString() ?? '0'"></h3>
                    </div>
                </div>
            </div>
            ...
            <div>
                ...
                <div class="bg-white border border-gray-100 rounded-xl overflow-hidden shadow-sm divide-y divide-gray-50">
