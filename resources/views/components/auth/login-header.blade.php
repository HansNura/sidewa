{{-- Login Card Header --}}
<header class="bg-green-800 px-8 py-8 text-center relative overflow-hidden">
    {{-- Pattern overlay inside header --}}
    ...
    <div class="relative z-10 flex flex-col items-center">
        ...
        {{-- Titles --}}
        <h1 class="text-2xl font-bold text-white tracking-tight">Sistem Informasi Desa</h1>
        <p class="text-green-100 text-sm mt-1">Panel Administrasi & Layanan Terpadu</p>
    </div>
</header>
