...
class DataController extends Controller
{
    ...
    public function penduduk()
    {
        ...
        $statistikPenduduk = [
            [
                ...
                'value' => 3823,
                'unit' => "Jiwa",
                'icon' => '<path stroke-linecap="round" stroke-linejoin="round" d="M15 19.128a9.38 9.38 0 0 0 2.625.372 9.337 9.337 0 0 0 4.121-.952 4.125 4.125 0 0 0-7.533-2.493m-3.663 3.664A9.337 9.337 0 0 1 12 11.37a9.337 9.337 0 0 1-3.663 3.664m0 0A9.337 9.337 0 0 1 12 7.63a9.337 9.337 0 0 1 3.663 3.664m0 0A9.337 9.337 0 0 0 12 18.37a9.337 9.337 0 0 0 3.663-3.664m-6.331 0a9.337 9.337 0 0 1-3.663-3.664m0 0A9.337 9.337 0 0 0 12 7.63a9.337 9.337 0 0 0-3.663 3.664m0 0a9.337 9.337 0 0 1-3.663-3.664" />',
                'isHighlight' => true,
            ...
            [
                ...
                'value' => 1234,
                'unit' => "KK",
                'icon' => '<path stroke-linecap="round" stroke-linejoin="round" d="M8.25 21v-4.875c0-.621.504-1.125 1.125-1.125h2.25c.621 0 1.125.504 1.125 1.125V21m0 0h4.5M3.938 21a9.001 9.001 0 1 0 18 0 9.001 9.001 0 0 0-18 0Z" />',
                'isHighlight' => false,
                'color' => "amber",
            ],
        ];
    ...
    public function wilayah()
    {
        ...
        $statistikWilayah = [
            [
                ...
                'value' => "1.210 Ha",
                'icon' => '<path stroke-linecap="round" stroke-linejoin="round" d="M3.75 21v-4.5m0 4.5h-1.5m1.5 0h1.5m-1.5 0v-4.5m0 4.5h1.5m-1.5 0h-1.5m3.75-9.75h1.5a.75.75 0 000-1.5h-1.5a.75.75 0 000 1.5zM3.75 12h1.5a.75.75 0 000-1.5h-1.5a.75.75 0 000 1.5zM3.75 6.75h1.5a.75.75 0 000-1.5h-1.5a.75.75 0 000 1.5zM3.75 9h1.5a.75.75 0 000-1.5h-1.5a.75.75 0 000 1.5zM6.75 21v-4.5m0 4.5h-1.5m1.5 0h1.5m-1.5 0V15M6.75 12h1.5a.75.75 0 000-1.5h-1.5a.75.75 0 000 1.5zM6.75 6.75h1.5a.75.75 0 000-1.5h-1.5a.75.75 0 000 1.5zM6.75 9h1.5a.75.75 0 000-1.5h-1.5a.75.75 0 000 1.5zm3-6.75h1.5a.75.75 0 000-1.5h-1.5a.75.75 0 000 1.5zM9.75 9h1.5a.75.75 0 000-1.5h-1.5a.75.75 0 000 1.5zm0 3h1.5a.75.75 0 000-1.5h-1.5a.75.75 0 000 1.5zm0 3.75h1.5a.75.75 0 000-1.5h-1.5a.75.75 0 000 1.5zm3-6.75h1.5a.75.75 0 000-1.5h-1.5a.75.75 0 000 1.5zm0 3h1.5a.75.75 0 000-1.5h-1.5a.75.75 0 000 1.5zm0 3.75h1.5a.75.75 0 000-1.5h-1.5a.75.75 0 000 1.5zm3-6.75h1.5a.75.75 0 000-1.5h-1.5a.75.75 0 000 1.5zm0 3h1.5a.75.75 0 000-1.5h-1.5a.75.75 0 000 1.5zm0 3.75h1.5a.75.75 0 000-1.5h-1.5a.75.75 0 000 1.5z" />',
                'isHighlight' => false,
                'color' => "blue",
            ],
            [
                'label' => "Total Dusun",
                'value' => $totalDusun,
                'icon' => '<path stroke-linecap="round" stroke-linejoin="round" d="M8.25 21v-4.875c0-.621.504-1.125 1.125-1.125h2.25c.621 0 1.125.504 1.125 1.125V21m0 0h4.5V3.545M12.75 21H8.25V10.888c0-.621.504-1.125 1.125-1.125h2.25c.621 0 1.125.504 1.125 1.125V21zM8.25 10.888V6.111c0-.621.504-1.125 1.125-1.125h2.25c.621 0 1.125.504 1.125 1.125V10.888M12.75 6.111V3.545M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />',
                'isHighlight' => false,
                'color' => "amber",
            ],
            [
                'label' => "Total RW",
                'value' => $totalRW,
                'icon' => '<path stroke-linecap="round" stroke-linejoin="round" d="M10.5 6a7.5 7.5 0 100 15 7.5 7.5 0 000-15zM5.25 9H10.5m0 0H10.5m0 0V3m0 3V9m0 6v3m0-3v-3m0 0h5.25M10.5 9h-5.25" />',
                'isHighlight' => false,
                'color' => "indigo",
            ],
            [
    ...
    public function kelompokUmur()
    {
        ...
        // Format array dengan default icon dan format unit yang konsisten
        foreach ($statistikKelompokUmur as &$item) {
            if (!isset($item['icon'])) {
                $item['icon'] = '<path stroke-linecap="round" stroke-linejoin="round" d="M18 18.72a9.094 9.094 0 0 0 3.741-.479 3 3 0 0 0-3.741-5.196M18 18.72V9.75m0 8.97V9.75M18 9.75h.008v.008H18V9.75Zm-6 9.015a9.095 9.095 0 0 1-3.741-.48 3 3 0 0 1 3.741-5.196m0 5.676V9.75m0 8.97V9.75m0 0h.008v.008H12V9.75Zm-6 9.015a9.095 9.095 0 0 1-3.741-.48 3 3 0 0 1 3.741-5.196m0 5.676V9.75m0 8.97V9.75m0 0h.008v.008H6V9.75Z" />';
            }
            if (!isset($item['unit'])) {
                $item['unit'] = "Jiwa";
            }
